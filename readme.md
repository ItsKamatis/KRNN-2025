...
**TA-Lib note:** TA-Lib is an annoying dependency on Windows. If pip install fails, install TA-Lib via a platform-appropriate method (often easiest via conda-forge), then re-run the requirements install.
